...
namespace GameLibrary
{
    ...
    /// </summary>
    public class ColorField : UC_RenderableBounded
    {
    ...
    /// </summary>
    public class TextRenderableBordered : UC_RenderableBounded
    {
    ...
    /// A line of text in a frame so to speak the border will have illusion of 3D if its not pure black or white
    /// </summary>
    public class Button : UC_RenderableBounded
    {
        public string text { get; set; }
        public SpriteFont font { get; set; }
        public Vector2 textOffset;
    ...
    /// </summary>
    class CircleFade : UC_RenderableBounded //(and resize as well)
    {
        Color finalColour;
        Color initColour;
    ...
    /// </summary>
    public class ScrollBackGround : UC_RenderableBounded
    {
    ...
    /// </summary>
    public class BlinkingBoxes : UC_RenderableBounded
    {
    ...
    /// </summary>
    public class RepeatImage : UC_RenderableBounded
    {
    ...
    /// </summary>
    public class ImageBackground : UC_RenderableBounded
    {
    ...
    /// It can be acuratel positioned by changing Offset
    /// It can be animated by changing delta and updateModulo
    /// Vertoical or horizontal lines may be omitted by setting drawVertical ot drawHorizontal to false
    /// 
    ...
    /// </summary>
    public class GridBackGround : UC_RenderableBounded
    {
        Color lineColour1;
