...
namespace GameLibrary
{
    ...
    public class UC_Renderable
    {
        ...
        public UC_Renderable(bool activeZ, bool visibleZ, Color colorZ)
        {
            active = activeZ;
            visible = visibleZ;
            colour = colorZ;
        ...
        /// </summary>
        public UC_Renderable(UC_Renderable r)
        {
            active = r.active;
            visible = r.visible;
            colour = r.colour;
    ...
    /// the idea is that inactive renderables can have their plac re-used and are no longer needed
    /// </summary>
    public class UC_RenderableList : UC_Renderable
    {
        ...
        /// <param name="i"></param>
        /// <returns></returns>
        public UC_Renderable getRenderable(int i)
        {
            UC_Renderable retv = rlist[i];
            return retv;
        ...
        /// <summary>
        /// If the renderable list only contains UC_RenderableBounded it will return
        ...
        public int Contains(float x, float y)
        {
            for (int i = 0; i < rlist.Count; i++)
            {
                ...
                if (((UC_RenderableBounded)(rlist[i])).bounds.Contains((int)x, (int)y))
                {
                    return i;
                }
            }
    ...
    /// </summary>
    public class UC_RenderableAttached : UC_Renderable
    {
