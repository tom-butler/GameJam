...
namespace GameLibrary
{
    ...
    public class Sprite3Parent : UC_RenderableBounded
    {
        ...
        /// WARNING - Bounding boxes are in source pixels not screen pixels
        /// </summary>
        ...
        /// </summary>
        protected Vector2 savePos; // the screen position temp store for return to after colission
        ...
        /// <summary>
        /// boundingSphereRaduius is in display pixels from the location (hotspot)
        /// its not yet used but is here for future expansion in 2014
        /// </summary>
        public float boundingSphereRaduius = 0;
    ...
    /*
     * The difence between sprite2 and sprite3 is as follows
     ...
     * c) Sprite 3 supports the bounded renderable bounds as a property (but at this stage without allowing for rotation)
    */

    /// <summary>
    /// The UC_Framework Sprite3 Class
    ...
    public class Sprite3 : Sprite3Parent
    {
        ...
        /// </summary>
        public const string SpriteVersion = "V3.02";
        ...
        /// it is often used as a point to move towards
        /// </summary>
        ...
        /// this turns out to be a usefull variable for debugging
        /// </summary>
        ...
        /// </summary>
        public UC_RenderableAttached attachedRenderable
        {
        ...
        private UC_RenderableAttached renderableAttached = null;
        ...
        /// this is not usually of any use if the image is being resized due to the bb resizing
        /// </summary>
        /// <param name="w"></param>
        /// <param name="h"></param>
    ...
    /// </summary>
    public class SpriteFactoryParent : UC_Renderable // from renderable to give us update loops and ability to use lists 
    {
        /// <summary>
